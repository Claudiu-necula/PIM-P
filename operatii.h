...
// detecteaza forma conturului dat
...
// eticheteaza imaginea originala cu formele gasite
Mat labelShapes(Mat img, vector<vector<Point>> contours, vector<Moments> mu)
{
	...
	{
		// aproximeaza laturile poligonului
...
// calculeaza informatii cu privire la fiecare contur
...
// gaseste fiecare contur si coloreaza fiecare contur cu o culoare diferita
...
// uniformizeaza culoarea din imaginea data
...
// calculeaza procentajul fiecarei culori din imagine
...
// verifica fiecare procentaj ce culoare este
...
bool isCedeazaTrecerea() {
	if ((whiteC >= 14 && whiteC <= 35) && (redC >= 23 && redC <= 55) && blackC <= 2)
		return true;
	return false;
}
...
// gaseste semnul pe baza culorii 
...
// ia formele geometrice gasite, 
// creaaza o masca si 
// cropeaza forma din imaginea originala
// apoi trimite la fct pt recunoasterea semnului
